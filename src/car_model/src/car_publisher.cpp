...
class CarPublisher
{
        ...
        public:
                ...
                double move_x, move_y, move_z, px, py, pz, vx, vy;
...
void CarPublisher::initialize_transformation(geometry_msgs::TransformStamped* trans, nav_msgs::Odometry* odom)
{
        ...
        trans->transform.rotation = tf::createQuaternionMsgFromRollPitchYaw(0,0,this->angle-(M_PI/2));
        ...
        odom->pose.pose.orientation = tf::createQuaternionMsgFromRollPitchYaw(0,0,this->angle-(M_PI/2));
...
void CarPublisher::receive_Twist(const geometry_msgs::Twist msg)
{
        ...
        //move_x += (vx*cos(angle) - vy*sin(angle)) * dt;
        //move_y += (vx*sin(angle) + vy*cos(angle)) * dt;
        ...
        geometry_msgs::Quaternion quat = tf::createQuaternionMsgFromRollPitchYaw(0,0,angle-(M_PI/2));
...
void CarPublisher::default_publish(CarPublisher* car_pub)
{
        ...
        */
        ...
        for(;;)
        {
                ...
                //car_pub->trans->transform.rotation = tf::createQuaternionMsgFromRollPitchYaw(0,0,car_pub->angle-(M_PI/2));
