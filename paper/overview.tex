...
angle to the closest one of the three angles. Although this may
...
Nevertheless, the trained model was still able to achieve reasonable a
degree of accuracy, successfully navigating several different tracks 
we trained. A collection of self-driving videos of the DeepPicar can
be found at: \url{https://github.com/heechul/picar/videos}.
