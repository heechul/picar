...
real-time systems by giving a dedicated cache space to individaul task
or core. In this experiment, we use PALLOC~\cite{yun2014rtas}, a
...
the DNN performance slightly worse that that of w/o partitioning. In
either case, the main observation is that cache partitioning is not
effective in providing timing isolation to our DNN workload.
