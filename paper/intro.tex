...
From our experiments, we discover that the DeepPicar is capable of 
...
provides a background of applications in autonomous driving. Section 
III gives an overview of the DeepPicar platform, including the 
...
determine their suitably for autonomous driving research. Related 
works are discussed in Section VI, and the paper finishes with 
