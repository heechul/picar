...
% need testbeds.
% but challenges 
%   (1) real-time processing (2) cost (3) safety (4) SWaP
...
% our goals:
%   (1) build a safe and low cost testbed but utilizing the
%       state-of-the-art AI technologies: DNN based end-to-end control
%   (2) analyze real-time issues in DNN based end-to-end control.
%   (3) evalute popular embedded platforms for the AI workloads
%       (end-to-end control, perception).
%       - Can apsberry pi handle AI workloads?
%       - Can embedded GPU do better? How much?
...
% how we trained and tested (in terms of network performance)
