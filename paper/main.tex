...
\titlerunning{DeepPicar: A Low-cost Autonomous Car} %optional, in case that the title is too long; the running title should fit into the top page column
...
\keywords{Self-driving car, CNN, Raspberry Pi 3}% mandatory: Please provide 1-5 keywords
% Author macros::end %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
