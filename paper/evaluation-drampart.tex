...
bandwidth budget because MemGuard currently only accounts for L2 refills
but not write-backs, which effectively allows twice the allocated
memory bandwidth budget. Regardless, the results clearly show that
limiting the co-runners's memory bandwidth is effective in protecting the
