...
explained by increased contention in the L2 cache space. Instead, the 
total number of bus accesses made while the model is running increases
dramatically, which explains why the DNN's performance decreased.
As such, the high memory bandwidth pressure from the co-scheduled
