...
%% We believe, though, that this can be
%% rectified through the collection of additional data for training and
%% validation.

%% \begin{figure*}[h]
%%   \centering
%%   \includegraphics[width=.9\textwidth]{figs/graph_run=.pdf}
...
%% Specifically, these issues all have the potential to negatively
